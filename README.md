...
<h2>Description</h2>
A 2D game using Unity/C#. Players explores a dungeon room, avoiding enemies, dropping baits and utilizing environmental hazards to reach the next level. The game features:
<ul>
